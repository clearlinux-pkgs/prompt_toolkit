...
Source0  : https://files.pythonhosted.org/packages/8f/bc/58ba47a2a864d8e3d968d03b577c85fbdf52c8d324a030df71ac9c06c1b5/prompt_toolkit-3.0.3.tar.gz
...
%prep
%setup -q -n prompt_toolkit-3.0.3
cd %{_builddir}/prompt_toolkit-3.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583203479
...
cp %{_builddir}/prompt_toolkit-3.0.3/LICENSE %{buildroot}/usr/share/package-licenses/prompt_toolkit/3f9fcc5a3e1595282b9841f8258755e753f26461
