...
%prep
%setup -q -n prompt_toolkit-3.0.7
cd %{_builddir}/prompt_toolkit-3.0.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598903648
...
cp %{_builddir}/prompt_toolkit-3.0.7/LICENSE %{buildroot}/usr/share/package-licenses/prompt_toolkit/3f9fcc5a3e1595282b9841f8258755e753f26461
