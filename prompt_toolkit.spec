...
Source0  : https://files.pythonhosted.org/packages/b1/46/4eb242362c43cf033b4ec4d7205612c46c9f904a8984cdfdb64d35476175/prompt_toolkit-3.0.14.tar.gz
...
%prep
%setup -q -n prompt_toolkit-3.0.14
cd %{_builddir}/prompt_toolkit-3.0.14
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611592719
...
cp %{_builddir}/prompt_toolkit-3.0.14/LICENSE %{buildroot}/usr/share/package-licenses/prompt_toolkit/3f9fcc5a3e1595282b9841f8258755e753f26461
