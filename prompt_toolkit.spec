...
Source0  : https://files.pythonhosted.org/packages/3e/8c/9b93fd9ae393a41c92c1a5b9042a048ef4650853ca6ff9e0818781a01e2f/prompt_toolkit-3.0.17.tar.gz
...
%prep
%setup -q -n prompt_toolkit-3.0.17
cd %{_builddir}/prompt_toolkit-3.0.17
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615563608
...
cp %{_builddir}/prompt_toolkit-3.0.17/LICENSE %{buildroot}/usr/share/package-licenses/prompt_toolkit/3f9fcc5a3e1595282b9841f8258755e753f26461
