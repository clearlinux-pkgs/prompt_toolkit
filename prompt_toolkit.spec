...
Source0  : https://files.pythonhosted.org/packages/4f/18/77e8da1f8342f561c7fccb5701398200bd7c9b1227ee15ad370086bc71d8/prompt_toolkit-3.0.10.tar.gz
...
%prep
%setup -q -n prompt_toolkit-3.0.10
cd %{_builddir}/prompt_toolkit-3.0.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610120774
...
cp %{_builddir}/prompt_toolkit-3.0.10/LICENSE %{buildroot}/usr/share/package-licenses/prompt_toolkit/3f9fcc5a3e1595282b9841f8258755e753f26461
