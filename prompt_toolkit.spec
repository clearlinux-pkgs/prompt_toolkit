...
Source0  : https://files.pythonhosted.org/packages/d3/66/c9cd6b943bce914b5d5abd129224a0c889fcd7927d3fbcf6b50d0f1fb9d7/prompt_toolkit-3.0.11.tar.gz
...
%prep
%setup -q -n prompt_toolkit-3.0.11
cd %{_builddir}/prompt_toolkit-3.0.11
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611172863
...
cp %{_builddir}/prompt_toolkit-3.0.11/LICENSE %{buildroot}/usr/share/package-licenses/prompt_toolkit/3f9fcc5a3e1595282b9841f8258755e753f26461
