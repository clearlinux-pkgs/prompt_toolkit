...
Source0  : https://files.pythonhosted.org/packages/53/96/b3bff620964869c07252fc2eac4e7e2dd48aea07314d932d21cfd92428da/prompt_toolkit-3.0.22.tar.gz
...
%prep
%setup -q -n prompt_toolkit-3.0.22
cd %{_builddir}/prompt_toolkit-3.0.22
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636041255
...
cp %{_builddir}/prompt_toolkit-3.0.22/LICENSE %{buildroot}/usr/share/package-licenses/prompt_toolkit/3f9fcc5a3e1595282b9841f8258755e753f26461
