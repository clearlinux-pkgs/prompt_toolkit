...
Source0  : https://files.pythonhosted.org/packages/88/4b/2c0f9e2b52297bdeede91c8917c51575b125006da5d0485521fa2b1e0b75/prompt_toolkit-3.0.19.tar.gz
...
%prep
%setup -q -n prompt_toolkit-3.0.19
cd %{_builddir}/prompt_toolkit-3.0.19
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624028152
...
cp %{_builddir}/prompt_toolkit-3.0.19/LICENSE %{buildroot}/usr/share/package-licenses/prompt_toolkit/3f9fcc5a3e1595282b9841f8258755e753f26461
