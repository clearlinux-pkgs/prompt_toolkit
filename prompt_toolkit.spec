...
Source0  : https://files.pythonhosted.org/packages/f7/e0/47738dadee0ec15ffbfa926f01586db2397201e0af3e06a0e669adfd6f2f/prompt_toolkit-3.0.18.tar.gz
...
%prep
%setup -q -n prompt_toolkit-3.0.18
cd %{_builddir}/prompt_toolkit-3.0.18
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1616430785
...
cp %{_builddir}/prompt_toolkit-3.0.18/LICENSE %{buildroot}/usr/share/package-licenses/prompt_toolkit/3f9fcc5a3e1595282b9841f8258755e753f26461
