...
Source0  : https://files.pythonhosted.org/packages/69/19/3aa4bf17e1cbbdfe934eb3d5b394ae9a0a7fb23594a2ff27e0fdaf8b4c59/prompt_toolkit-3.0.5.tar.gz
...
%prep
%setup -q -n prompt_toolkit-3.0.5
cd %{_builddir}/prompt_toolkit-3.0.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585268094
...
cp %{_builddir}/prompt_toolkit-3.0.5/LICENSE %{buildroot}/usr/share/package-licenses/prompt_toolkit/3f9fcc5a3e1595282b9841f8258755e753f26461
