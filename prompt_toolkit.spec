...
Source0  : https://files.pythonhosted.org/packages/c0/50/3050bb288d0c981f073b4e83ae67e92fd286a55e81b29c9df288a2afb12f/prompt_toolkit-3.0.23.tar.gz
...
%prep
%setup -q -n prompt_toolkit-3.0.23
cd %{_builddir}/prompt_toolkit-3.0.23
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638366628
...
cp %{_builddir}/prompt_toolkit-3.0.23/LICENSE %{buildroot}/usr/share/package-licenses/prompt_toolkit/3f9fcc5a3e1595282b9841f8258755e753f26461
