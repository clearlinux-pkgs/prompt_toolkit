...
Source0  : https://files.pythonhosted.org/packages/c4/c6/03da4efaf73f0cb5a34957fdac12046eb8d8e81618bad6f60464215b829a/prompt_toolkit-3.0.6.tar.gz
...
%prep
%setup -q -n prompt_toolkit-3.0.6
cd %{_builddir}/prompt_toolkit-3.0.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597081143
...
cp %{_builddir}/prompt_toolkit-3.0.6/LICENSE %{buildroot}/usr/share/package-licenses/prompt_toolkit/3f9fcc5a3e1595282b9841f8258755e753f26461
