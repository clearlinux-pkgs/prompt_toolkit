...
Source0  : https://files.pythonhosted.org/packages/d4/12/7fe77b49d67845a378cfadb484b64218ed09d0e8bf420c663b4fe28f0631/prompt_toolkit-3.0.8.tar.gz
...
%prep
%setup -q -n prompt_toolkit-3.0.8
cd %{_builddir}/prompt_toolkit-3.0.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602549635
...
cp %{_builddir}/prompt_toolkit-3.0.8/LICENSE %{buildroot}/usr/share/package-licenses/prompt_toolkit/3f9fcc5a3e1595282b9841f8258755e753f26461
