...
Source0  : https://files.pythonhosted.org/packages/61/c9/56131b4753ef14bffd06754846c63de78b3a868e995763f6410381a6fb98/prompt_toolkit-3.0.4.tar.gz
...
%prep
%setup -q -n prompt_toolkit-3.0.4
cd %{_builddir}/prompt_toolkit-3.0.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583537334
...
cp %{_builddir}/prompt_toolkit-3.0.4/LICENSE %{buildroot}/usr/share/package-licenses/prompt_toolkit/3f9fcc5a3e1595282b9841f8258755e753f26461
